...
<body>
    <nav class="navbar navbar-dark bg-primary d-flex justify-content-between">
            ...
            <div class="dropdown-menu" align="right">
                ...
                <a class="dropdown-item" href="http://www.cs.virginia.edu/~jme3tp/db_project/employee_make_transaction.php">Make a Transaction</a>
                <a class="dropdown-item" href="http://www.cs.virginia.edu/~jme3tp/db_project/owner_input_shipment.php"> Complete a Shipment</a>
                <a class="dropdown-item" href="http://www.cs.virginia.edu/~jme3tp/db_project/owner_change_set_shifts.php">Assign Shifts</a>
                <a class="dropdown-item" href="http://www.cs.virginia.edu/~jme3tp/db_project/owner_fix_stock.php"> Fix Stock</a>
    ...
    <div class="container">
        ...
        <a class="btn btn-block btn-primary" href="http://www.cs.virginia.edu/~jme3tp/db_project/employee_make_transaction.php"> Make a Transaction </a>
        <a class="btn btn-block btn-primary" href="http://www.cs.virginia.edu/~jme3tp/db_project/owner_input_shipment.php"> Complete a Shipment</a>
        ...
        <a class="btn btn-block btn-primary" href="http://www.cs.virginia.edu/~jme3tp/db_project/owner_fix_stock.php"> Fix Stock</a>
    </div>
    </div>
</body>
</html>