...
<?php
  if (isset($_POST['submit_transaction'])) {
    ...
    $result = mysqli_query($con, "SELECT MAX(SHIPMENT_ID) FROM SHIPMENTS");    
    if (!$result) {
    ...
    $user = $_SESSION['o_id'];
    $sql = "INSERT INTO SHIPMENTS (STORE_ID, OWNER_ID, ITEM_UPC, AMOUNT) VALUES ('$_POST[store_number]','$user', '$_POST[item_upc]','$_POST[amount]')";
